...
# patient_p = patient(1, "aksh", "gosavi", "male", 24)
# sqlite_Dbmanager.insert_patient(patient_p)
# print(sqlite_Dbmanager.get_all_patients())
# sqlite_Dbmanager.delete_all_patient()
# sqlite_Dbmanager.delete_patient(patient_p)
...
def show_patient_menu():
    ...
    print('Choose 8 to create table patients')
    choice = int(input())
    match choice:
        case 1:
